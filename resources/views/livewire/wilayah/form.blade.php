                                ...
                                <div class="card-body">
                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="form-item flex gap-2">
                                            <div class="w-full">
                                                <x-admin.input label="Nama Wilayah" id="nama-wilayah" name="wilayah.nama_wilayah" :isDisabled="$isDisabled" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="form-item flex gap-2">
                                            <div class="w-full">
                                                <x-admin.select label="Koordinator Wilayah" id="pegawai" name="wilayah.pegawai_id"  :isDisabled="$isDisabled">
                                                    <option>Pilih</option>
                                                    @foreach ($pegawai as $item)
                                                        <option value="{{$item['id']}}">{{$item['nama_depan'] ?? ''}} {{$item['nama_belakang'] ?? ''}}</option>
                                                    @endforeach
                                                </x-admin.select>
                                                @error('wilayah.pegawai_id') <span class="text-red-400">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-item flex gap-2">
                                        <div class="w-full">
                                            <x-admin.textarea label="Keterangan" id="keterangan" name="wilayah.keterangan" :isDisabled="$isDisabled" />
                                        </div>
                                    </div>
                                </div>
                            </div>
