            ...
            <div class="bg-white px-2 py-4 rounded-lg shadow-2xl">
                <div class="card-body">
                        ...
                        <div class="flex flex-col justify-end gap-2">
                            ...
                            <div class="ml-auto" x-show="menu === 'detail'">
                                <div class="flex gap-2">
                                    @can('edit')
                                        <x-button-custom id="edit-button" tooltip="UBAH DATA!" action="edit({{$id}})" class="btn btn-xs btn-solid">
                                            <x-slot name="icon">
                    ...
                    @if($menu === 'tambah' || ($menu === 'ubah' && $id != '') || ($menu === 'detail' && $id != ''))
                        <livewire:admin.data-master.diklat.form :id="$id" :menu="$menu" :isDisabled="$isDisabled"/>
                    @else
                        <livewire:admin.data-master.diklat.record />
                    @endif
