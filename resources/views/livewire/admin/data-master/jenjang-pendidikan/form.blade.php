                            ...
                            <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                                <div class="card-body">
                                    <div class="form-item flex gap-2">
                                        <div class="w-1/2">
                                            <x-admin.input label="Jenjang Pendidikan" id="jenjangPendidikan" name="jenjangPendidikan.jenjang_pendidikan"  :isDisabled="$isDisabled" />
                                        </div>
                                    </div>
                                    <div class="form-item flex gap-2">
                                        <div class="w-full">
                                            <x-admin.textarea label="Keterangan" id="catatan" name="jenjangPendidikan.keterangan" :isDisabled="$isDisabled" />
                                        </div>
                                    </div>
                                </div>
                            </div>
