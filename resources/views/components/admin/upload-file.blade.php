@props(['title' => '', 'subtitle'=>'', 'id' => '', 'label' => '', 'name' => '', 'img' => ''])
<h5>{{$title}}</h5>
<p class="mb-2">{{$subtitle}}</p>
<div class="upload upload-draggable hover:border-primary-600 @error($name) border-red-500 hover:border-red-500 @enderror">
    <div
        wire:ignore
        x-data="{
                id: @js($id),
