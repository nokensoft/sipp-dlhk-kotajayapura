(() => {
    var e = {
            241: (e) => {
                ...
                (e.exports = a()), (e.exports.createColors = a);
            },
            808: (e, f, a) => {
                let r = a(921);
            ...
            921: (e, f, a) => {
                ...
                function d({ version: e, from: f, to: a }) {
                    r.default.warn(`${f}-color-renamed`, [
            ...
            679: (e, f, a) => {
                ...
                function o(e, f, a) {
                    ("undefined" != typeof process &&
                        ...
                        (a && d.add(a),
                        console.warn(""),
                        f.forEach((f) => console.warn(e, "-", f)));
                }
                function n(e) {
                    return r.default.dim(e);
                }
                const c = {
                    info(e, f) {
                        o(
    ...
    function a(r) {
        ...
        var d = (f[r] = { exports: {} });
        return e[r](d, d.exports, a), d.exports;
    }
    (a.n = (e) => {
        ...
        (() => {
                ...
                n = {
                    ...
                    f.cyan[100],
                    {
                        ...
                        legend: {
                            ...
                            tooltipHoverFormatter: function (e, f) {
                                return (
                                    e +
                                    " - " +
                                    f.w.globals.series[f.seriesIndex][
                                        f.dataPointIndex
                                    ]
                                );
                            },
                    ...
                    series: [
                        {
                            name: "Laki-Laki",
                            data: [9, 7, 5, 3, 1, 9, 7, 5, 3, 1, 9, 7, 5, 3],
                            color: r,
                        },
                        {
                            name: "Perempuan",
                            data: [12, 10, , 8, 6, 4, 2, 12, 10, 8, 6, 4, 2],
                            color: d,
                        },
                    ],
                    chart: {
            ...
            const c = (function (e) {
                ...
                return `${String(e.getMonth() + 1).padStart(2, "0")}/${String(
                    e.getDate()
                ).padStart(2, "0")}/${f}`;
            })(new Date());
            document
                .querySelector(".project-calendar")
                .setAttribute("data-date", c);
        })();
})();
