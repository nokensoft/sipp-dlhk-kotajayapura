...
class Index extends Component
{
    ...
    public string $subtitle = "Data distrik untuk setiap petugas PNS";
    public string $title = "Distrik";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data distrik untuk setiap petugas lapangan";
        }
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-distrik', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'Distrik', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
    ...
    {
        return view('livewire.admin.data-master.distrik.index');
    }
