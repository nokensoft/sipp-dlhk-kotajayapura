...
class Index extends Component
{
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data kelurahan untuk setiap petugas lapangan";
        }
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-kelurahan', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'Kelurahan', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
    ...
    {
        return view('livewire.admin.data-master.kelurahan.index');
    }
