...
class Index extends Component
{
    ...
    public string $subtitle = "Data pangkat/golongan kerja di untuk setiap petugas lapangan";
    ...
    {
        if($this->menu === 'detail'){
            $this->dispatch('load-pangkat-golongan', id:$id, menu: 'ubah');
        }
        $this->menu='ubah';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute('pangkatGolongan', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
