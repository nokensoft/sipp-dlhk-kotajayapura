...
class Index extends Component
{
    ...
    public string $subtitle = "Jenis kelamin depan untuk setiap petugas lapangan";
    public string $title = "Jenis Kelamin";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data jenis kelamin untuk setiap petugas lapangan";
        }
    ...
    {
        if ($this->menu === 'create') {
            $this->redirect(route('jenisKelamin'));
        }
        if ($this->menu === '') {
            $this->menu = 'create';
            $this->buttonTitle = 'Kembali';
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-jenis-kelamin', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'Jenis Kelamin', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
    ...
    {
        return view('livewire.admin.data-master.jenis-kelamin.index');
    }
