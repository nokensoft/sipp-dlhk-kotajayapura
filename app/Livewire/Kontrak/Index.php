...
class Index extends Component
{
    ...
    public string $subtitle = "Data kontrak kerja di untuks setiap petugas lapangan";
    public string $title = "Kontrak";
    ...
    public function mount(): void
    {
        if ($this->menu === 'create') {
            ...
            $this->subtitle = "Tambah data kontrak kerja untuk setiap petugas lapangan";
        }
    ...
    {
        if($this->menu === 'view'){
            $this->dispatch('load-kontrak', id:$id, menu: 'edit');
        }
        $this->menu='edit';
        $this->id = $id;
        $this->buttonMenu();
    ...
    public function delete($id): void
    {
        try {
            ...
            $this->redirectRoute($this->title === 'Kontrak', ['menu' => 'tempat_sampah']);
        }catch (\Exception $e){
